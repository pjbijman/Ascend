...
public class Game extends Canvas{
	...
	private static final long serialVersionUID = 5897159840120601963L;
	...
	ArrayList<Room> rooms = new ArrayList<>(roomAmount);
	ArrayList<Tile> corridorTiles = new ArrayList<>();
	...
	public static void main(String[] args) {
		...
		printField(game);
		game.createFrame(250, 510, "Ascend", game);;
	}
	...
	public void createFrame(int width, int height, String title, Game game){
